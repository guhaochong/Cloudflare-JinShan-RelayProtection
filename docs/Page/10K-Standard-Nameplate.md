...
| 5    | XX A-B FA 功能投入压板   | XX为开关站站名；A-B为电源仓编号 | 解除 |
| 6    | XX A-B FA 功能投入压板   | XX为开关站站名；A-B为电源仓编号 | 解除 |
| 7    | 站控交换机               | 站内保护装置用交换机            |      |
| 8    | 配网交换机               | 光纤通信用交换机                |      |
| 9    | 配网加密装置             | 后台外置加密装置                |      |
| 10   | 保信子站交换机           |                                 |      |
...
| 序号 | 铭牌名称                      | 备注信息                                     | 型号  |
| ---- | ----------------------------- | -------------------------------------------- | ----- |
| 1    | XX自愈压变小开关              | XX为整串名+A串                               | C1 4P |
| 2    | XX自愈压变小开关              | XX为整串名+B串                               | C1 3P |
| 3    | XX自愈压变小开关              | XX为整串名+A串                               | C1 4P |
| 4    | XX自愈压变小开关              | XX为整串名+B串                               | C1 3P |
| 5    | XX自愈保护电源小开源          | XX为整串名+A串                               | 6A    |
| 6    | XX自愈保护电源小开源          | XX为整串名+B串                               | 6A    |
| 7    | 10千伏XX串自愈投入压板        | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
| 8    | 10千伏XX串母线保护投入压板    | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
| 9    | 10千伏XX串故障解列投入压板    | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
| 10   | 10千伏XX低频低压投入压板      | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
| 11   | XX自愈隔离压板                | XX为线路名称；压板为黄色；上桩为正电源；     |       |
| 12   | XX自愈隔离压板                | XX为线路名称；压板为黄色；上桩为正电源；     |       |
| 13   | 10分段X串自愈检修压板         | X为A/B串；压板为黄色；上桩为正电源；         |       |
| 14   | 10千伏XX串自愈远方控制压板    | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
| 15   | 10千伏XX串自愈装置检修压板    | XX为整串名+A/B串；压板为黄色；上桩为正电源； |       |
...
| 20   | 10千伏分段开关X串自愈跳闸压板 | XX为线路名称；压板为红色；上桩为开关线圈     |       |
| 21   | 10千伏分段开关X串自愈合闸压板 | XX为线路名称；压板为红色；上桩为开关线圈     |       |
| 22   | 备用                          |                                              |       |
| 23   | 备用                          |                                              |       |
| 24   | 备用                          |                                              |       |
