...
| 序号 | 铭牌名称                       | 备注信息                                     | 型号  |
| ---- | ------------------------------ | -------------------------------------------- | ----- |
| 1    | 10千伏XX一段自愈压变小开关     | XX为整串名（A串）                            | C1 4P |
| 2    | 10千伏XX二段自愈压变小开关     | XX为整串名（A串）                            | C1 3P |
| 3    | 10千伏XX二段自愈压变小开关     | XX为整串名（B串）                            | C1 4P |
| 4    | 10千伏XX一段自愈压变小开关     | XX为整串名（B串）                            | C1 3P |
...
| 13   | 10千伏分段XX串自愈检修压板     | XX为整串名A/B串；压板为黄色；上桩为正电源；  |       |
...
| 20   | 10千伏分段开关XX串自愈跳闸压板 | XX为线路名称；压板为红色；上桩为开关线圈     |       |
| 21   | 10千伏分段开关XX串自愈合闸压板 | XX为线路名称；压板为红色；上桩为开关线圈     |       |
