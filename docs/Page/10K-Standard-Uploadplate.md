...
| 134  | 预留                                 | 自愈信号占用                                                 | 135  |
| 135  | 预留                                 | 自愈信号占用                                                 | 136  |
| 136  | A环 FA 未准备                        | FA信号占用                                                   | 137  |
| 137  | A环 FA 投入软压板                    | FA信号占用                                                   | 138  |
| 138  | A环 FA 动作                          | FA信号占用                                                   | 139  |
| 139  | A环 FA 开关拒动                      | FA信号占用                                                   | 140  |
| 140  | A环 FA 负荷越限                      | FA信号占用                                                   | 141  |
| 141  | A环 FA 通信异常                      | FA信号占用                                                   | 142  |
| 142  | A环 FA 装置异常                      | FA信号占用                                                   | 143  |
| 143  | B环 FA 未准备                        | FA信号占用                                                   | 144  |
| 144  | B环 FA 投入软压板                    | FA信号占用                                                   | 145  |
| 145  | B环 FA 动作                          | FA信号占用                                                   | 146  |
| 146  | B环 FA 开关拒动                      | FA信号占用                                                   | 147  |
| 147  | B环 FA 负荷越限                      | FA信号占用                                                   | 148  |
| 148  | B环 FA 通信异常                      | FA信号占用                                                   | 149  |
| 149  | B环 FA 装置异常                      | FA信号占用                                                   | 150  |
| 150  | C环 FA 未准备                        | FA信号占用                                                   | 151  |
| 151  | C环 FA 投入软压板                    | FA信号占用                                                   | 152  |
| 152  | C环 FA 动作                          | FA信号占用                                                   | 153  |
| 153  | C环 FA 开关拒动                      | FA信号占用                                                   | 154  |
| 154  | C环 FA 负荷越限                      | FA信号占用                                                   | 155  |
| 155  | C环 FA 通信异常                      | FA信号占用                                                   | 156  |
| 156  | C环 FA 装置异常                      | FA信号占用                                                   | 157  |
| 157  | D环 FA 未准备                        | FA信号占用                                                   | 158  |
| 158  | D环 FA 投入软压板                    | FA信号占用                                                   | 159  |
| 159  | D环 FA 动作                          | FA信号占用                                                   | 160  |
| 160  | D环 FA 开关拒动                      | FA信号占用                                                   | 161  |
| 161  | D环 FA 负荷越限                      | FA信号占用                                                   | 162  |
| 162  | D环 FA 通信异常                      | FA信号占用                                                   | 163  |
| 163  | D环 FA 装置异常                      | FA信号占用                                                   | 164  |
...
| 38   | 自愈占用               | 单点遥控 | 38   |
| 39   | 自愈占用               | 单点遥控 | 39   |
| 40   | A串 FA 功能投入压板    | 单点遥控 | 40   |
| 41   | B串 FA 功能投入压板    | 单点遥控 | 41   |
...
| 40   | A串 FA 功能投入压板    | 单点遥控 | 40   |
| 41   | B串 FA 功能投入压板    | 单点遥控 | 41   |
| 42   | C串 FA 功能投入压板    | 单点遥控 | 42   |
| 43   | D串 FA 功能投入压板    | 单点遥控 | 43   |
